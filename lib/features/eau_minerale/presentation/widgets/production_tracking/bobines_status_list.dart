                  ...
                  ? (peutInstallerNouvelle
                      ? IntrinsicWidth(
                          child: OutlinedButton.icon(
                            onPressed: () => TrackingDialogs.showInstallNewBobineDialog(
                              context,
                              ref,
                              session,
                              bobine,
                  ...
                  : Row(
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed: () => TrackingDialogs.showMachineBreakdownDialog(
                            context,
                            ref,
                            session,
                            bobine,
                        ...
                        SizedBox(
                          width: 100,
                          child: OutlinedButton.icon(
                            onPressed: () => TrackingDialogs.showBobineFinishDialog(
                              context,
                              ref,
                              session,
                              bobine,
