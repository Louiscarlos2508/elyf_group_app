          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    '${day.nombrePersonnes} personne(s) le ${ProductionReportHelpers.formatDate(day.date)}',
                    style: theme.textTheme.bodyMedium?.copyWith(
                      fontWeight: FontWeight.w600,
                    ),
                  ),
                  Text(
                    'Salaire journalier: ${ProductionReportHelpers.formatCurrency(day.salaireJournalierParPersonne)}/personne',
