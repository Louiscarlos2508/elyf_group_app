...
class BoutiquePermissionGuard extends ConsumerWidget {
  const BoutiquePermissionGuard({
    super.key,
...
class BoutiquePermissionGuardAny extends ConsumerWidget {
  const BoutiquePermissionGuardAny({
    super.key,
...
class BoutiquePermissionGuardAll extends ConsumerWidget {
  const BoutiquePermissionGuardAll({
    super.key,
    required this.permissions,
    required this.child,
    this.fallback,
