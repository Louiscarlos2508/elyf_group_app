...
class _TreasuryOperationDialogState extends State<TreasuryOperationDialog> {
                ...
                Padding(
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(value: 'Caution / Garanti', child: Text('Caution / Garanti')),
              ...
              if (widget.type == TreasuryOperationType.removal)
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Bénéficiaire / Nom du Superviseur'),
  ...
  Future<void> _submit(WidgetRef ref) async {
    ...
    try {
      await ref.read(storeControllerProvider).recordTreasuryOperation(operation);
