...
class OrangeMoneyPermissionGuard extends ConsumerWidget {
  const OrangeMoneyPermissionGuard({
    super.key,
...
class OrangeMoneyPermissionGuardAny extends ConsumerWidget {
  const OrangeMoneyPermissionGuardAny({
    super.key,
...
class OrangeMoneyPermissionGuardAll extends ConsumerWidget {
  const OrangeMoneyPermissionGuardAll({
    super.key,
    required this.permissions,
    required this.child,
    this.fallback,
