...
class OrangeMoneyTreasuryOfflineRepository implements OrangeMoneyTreasuryRepository {
  OrangeMoneyTreasuryOfflineRepository(this._db, this.syncManager);
  ...
  Future<void> saveOperation(TreasuryOperation operation) async {
    ...
    await _db.into(_db.offlineRecords).insertOnConflictUpdate(
          OfflineRecordsCompanion(
            ...
            moduleType: const Value('orange_money'),
