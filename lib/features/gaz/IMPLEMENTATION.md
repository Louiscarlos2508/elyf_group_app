# Guide d'Implémentation - Module Gaz

## Vue d'ensemble

Ce guide explique comment implémenter de nouvelles fonctionnalités dans le module Gaz en suivant l'architecture Clean Architecture et les patterns établis.
...
## ⚠️ Repositories à Migrer

- `CylinderStockRepository` → CylinderStockOfflineRepository
- `CylinderLeakRepository` → CylinderLeakOfflineRepository
- `TourRepository` → TourOfflineRepository
- `PointOfSaleRepository` → PointOfSaleOfflineRepository
- `GazSettingsRepository` → GazSettingsOfflineRepository
