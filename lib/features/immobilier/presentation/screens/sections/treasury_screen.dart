  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      subtitle: Column(
        ...
        children: [
          Text(
            '${DateFormat('dd MMM yyyy, HH:mm').format(operation.date)} ${operation.referenceEntityType != null ? "(${operation.referenceEntityType})" : ""}',
      ...
      trailing: Column(
        ...
        children: [
          ...
          Text(
            operation.toAccount?.label ?? operation.fromAccount?.label ?? "N/A",
