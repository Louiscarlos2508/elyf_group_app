...
/// Adapter to use centralized permission system for immobilier module.
class ImmobilierPermissionAdapter {
  ImmobilierPermissionAdapter({
  ...
  static const String moduleId = 'immobilier';
