...
class PermissionInitializer {
  ...
  static void initializeAllPermissions() {
    ...
    registry.registerModulePermissions('gaz', GazPermissions.all);
    ...
    registry.registerModulePermissions('immobilier', ImmobilierPermissions.all);

    // Enregistrer les permissions du module Boutique
    registry.registerModulePermissions('boutique', BoutiquePermissions.all);
  ...
  static Map<String, Map<String, String>> getAllRegisteredPermissions() {
    ...
    for (final moduleId in registry.registeredModules) {
      ...
      if (modulePermissions != null) {
        result[moduleId] = {
          for (final perm in modulePermissions.values) perm.id: perm.name,
        };
      }
    }
